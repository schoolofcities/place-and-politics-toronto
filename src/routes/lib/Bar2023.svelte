<script>
	...
	$: boxes = [
		...
		[(votePercent["Chow"] / 100 + votePercent["Bailao"] / 100) * innerWidth, votePercent["Saunders"] / 100 * innerWidth],
        [(votePercent["Chow"] / 100 + votePercent["Bailao"] / 100 + votePercent["Saunders"] / 100)  * innerWidth, votePercent["Other"] / 100 * innerWidth]
	];
...
<div id="container" class="svg-container" bind:offsetWidth={divWidth}>
	<svg width={divWidth} {height} class="svg-content">
		<g transform={`translate(${margin.left},${margin.top})`}>
			...
			style="fill:#f6f6f6;stroke:white;stroke-width:1;" />
		</g>
	</svg>
</div>
