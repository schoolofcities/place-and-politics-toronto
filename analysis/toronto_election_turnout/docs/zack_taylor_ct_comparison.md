...
- `analysis/toronto_election_turnout/scripts/convert_zack_taylor_stata.py`
...
The script preserves all rows and columns in CSV form and writes sidecar metadata under `data/toronto_election_turnout/reference/`.
