const datasets = {
  municipal: {
    ...
    url: "/data/toronto_election_turnout/processed/toronto_municipal_2023_mayor_turnout_subdivisions.geojson",
    districtUrl: "/data/toronto_election_turnout/processed/toronto_municipal_2023_mayor_turnout_subdivisions_districts.json",
    districtLabel: "Ward"
  },
  provincial: {
    label: "Provincial 2025",
    url: "/data/toronto_election_turnout/processed/toronto_provincial_2025_turnout_poll_divisions.geojson",
    districtUrl: "/data/toronto_election_turnout/processed/toronto_provincial_2025_turnout_poll_divisions_districts.json",
    districtLabel: "Riding"
  },
  federal: {
    label: "Federal 2025",
    url: "/data/toronto_election_turnout/processed/toronto_federal_2025_turnout_poll_divisions.geojson",
    districtUrl: "/data/toronto_election_turnout/processed/toronto_federal_2025_turnout_poll_divisions_districts.json",
    districtLabel: "Riding"
  }
};
